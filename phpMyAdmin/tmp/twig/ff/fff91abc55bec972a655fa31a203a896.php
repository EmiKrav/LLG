...
class __TwigTemplate_97e87dcb176517cba1967997fa50ecf5 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "C:\\inetpub\\wwwroot\\phpMyAdmin\\templates\\database\\export\\index.twig");
    }
}
